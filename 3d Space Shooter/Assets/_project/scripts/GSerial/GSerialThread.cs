...
public class GSerialThread
{
    ...
    public BoardFunction board_function = BoardFunction.Unknown;
    private int baudRate;
    private int delayBeforeReconnecting = 1000;
    ...
    // ------------------------------------------------------------------------
    public GSerialThread(string portName, int baudRate) {
        Debug.Log("Connecting to " + portName);
    ...
    public void RunForever()
    {
        ...
        try
        {
            ...
            {
                serialPort.WriteLine((string) outputQueue.Dequeue());
            }
